    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-2xl mx-auto">
        <form action="{{ route('kriteria.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input id="nama_kriteria" name="nama_kriteria" type="text" value="{{ old('nama_kriteria') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                @error('nama_kriteria')
            ...
            <div class="mb-4 grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="bobot" name="bobot" type="number" value="{{ old('bobot') }}" min="1" max="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    @error('bobot')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
